...
| [WS-SESSION](workspace.md#ws-session)     | partial | —       | [traces.pl](../scripts/traces.pl), [traces.t](../t/ci/traces.t), [local.mk](../mk/local.mk), [workspace.md](../.claude/rules/workspace.md). Each target of WS-SESSION-8 has a column, and one merge met all four on 2026-09-09. Absent: WS-SESSION-4, an operator setting outside this repository.                 |
