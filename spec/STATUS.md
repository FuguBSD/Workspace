...
| [WS-DEPS](workspace.md#ws-deps)           | done    | —       | [Linux.txt](../deps/Linux.txt), [Darwin.txt](../deps/Darwin.txt), [SHA256.txt](../deps/SHA256.txt), [deps.t](../t/ci/deps.t) and [check.yml](../.github/workflows/check.yml). `t/ci/deps.t` cannot check the per-platform coverage of WS-DEPS-7, because the alias table lives in the org pack of FuguBSD/Tooling. |
...
| [WS-SESSION](workspace.md#ws-session)     | partial | —       | [traces.pl](../scripts/traces.pl), [traces.t](../t/ci/traces.t), [local.mk](../mk/local.mk), [workspace.md](../.claude/rules/workspace.md). Each target of WS-SESSION-8 has a column, and one merge met all three on 2026-09-09. Absent: WS-SESSION-4, an operator setting outside this repository.                |
